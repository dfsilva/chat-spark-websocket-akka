...
public class UsuarioActor extends AbstractLoggingActor {
	...
	public Receive createReceive() {
		return receiveBuilder().match(LoginMessage.class, this::login).match(UsuarioConectado.class, msg -> {
		...
		}).match(EncaminharMensagem.class, this::enviarMensagemChat).match(ReceberMensagem.class, this::receberMensagem)
				.build();
	}
